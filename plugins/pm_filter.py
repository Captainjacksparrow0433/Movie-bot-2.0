...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⬅️𝗕𝗮𝗰𝗸⬅️", callback_data=f"next_{req}_{key}_{off_set}"), InlineKeyboardButton(f"🌹 𝗣𝗮𝗴𝗲 {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages")]
        )
        ...
        btn.append(
            [
                ...
                InlineKeyboardButton("➡️𝗡𝗲𝘅𝘁➡️", callback_data=f"next_{req}_{key}_{n_offset}")
            ],
        )
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[            
            ...
            InlineKeyboardButton('🗳️ 𝐂𝐨𝐧𝐧𝐞𝐜𝐭 🗳️', callback_data='coct'),
            ...
            InlineKeyboardButton('🖥️ 𝐏𝐚𝐬𝐭𝐞 🖥️', callback_data='paste')
            ],[
            ...
            InlineKeyboardButton('🖨️ 𝐉𝐬𝐨𝐧 🖨️', callback_data='json')
            ],[
            InlineKeyboardButton('📌 𝐏𝐢𝐧 📌', callback_data='pin'),
            InlineKeyboardButton('🦠 𝐂𝐨𝐯𝐢𝐝 🦠', callback_data='corona'),
            InlineKeyboardButton('🖨️ 𝐒𝐭𝐢𝐜𝐤𝐞𝐫𝐈𝐃 🖨️', callback_data='stickerid')
            ],[
        ...
        buttons= [[
            ...
            InlineKeyboardButton('🎥𝙾𝚃𝚃 𝙼𝙾𝚅𝙸𝙴𝚂🎥', url=f'https://t.me/filmboxcommunity'), 
            InlineKeyboardButton('🛠Help🛠', callback_data='help')
            ],[
            InlineKeyboardButton('🔙Back🔙', callback_data='start'),
